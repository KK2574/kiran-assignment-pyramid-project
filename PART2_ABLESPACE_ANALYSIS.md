...
6. The ⋮ menu presumably surfaces secondary actions (edit student, view history, remove from caseload, etc.).
...
- **Search is name-only**: The search bar ("Search students...") likely only matches names. Being able to search/filter by group, school, or collaborator would help larger caseloads.
