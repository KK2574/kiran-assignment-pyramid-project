...
export default function ProjectsPage() {
  ...
  const handleAdd = () => {
    ...
    // updateProject will target the most-recently-added project once state settles
  };
          ...
          >
            {editingId === p.id ? (
              <input
                ...
                defaultValue={p.name}
                onBlur={(e) => {
                  updateProject(p.id, { name: e.target.value || "Untitled" });
                  setEditingId(null);
                }}
              ...
              <button
                ...
                className="text-left text-blue-500 hover:underline w-fit"
              >
                {p.name}
              </button>
            )}
